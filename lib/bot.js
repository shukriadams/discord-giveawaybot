        ...
        return new Promise(async function(resolve, reject){
            try {
                ...
                if (requestedCommand !== 'channel' && !this.settings.values.giveawayChannelId)
                    message.author.send(this.trace(`Giveaway channel not set - please go to your intended giveaway channel and ${hi('@me channel')} where 'me' is my botname.`, codes.ALERT_CHANNELNOTSET));
